                ...
                <Container fluid>
                    <Row>
                        <Col>
                            ...
                            <Form method="POST" onSubmit={(event) => this.handleSubmit(event, this.props.loginUser)}>
                                <Form.Group controlId="username">
                                    <Form.Label>Nickname</Form.Label>
                                    <Form.Control type="text" name="nickname" placeholder="Nickname" value={this.state.username} onChange={(ev) => this.onChangeUsername(ev)} required autoFocus />
                                </Form.Group>
